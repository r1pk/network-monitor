...
You can view the results of the measurements at any time at `127.0.0.1:3000/internet-speed-snapshot` (replace `3000` with the port set in your `.env`/`.env.local` file).
